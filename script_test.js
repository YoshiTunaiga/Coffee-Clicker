...
// That's the end of Slice 2! In the browser, you should now have an 
// interactive app that lets you click the coffee mug to get coffee, and 
// renders producers to the screen as they become unlocked.

// Next, we'll wire up the 'buy' buttons on the proucers and set up a 'tick' function 
// that 'runs' the producers, adding coffee automatically every second based on what 
// producers the player has!
